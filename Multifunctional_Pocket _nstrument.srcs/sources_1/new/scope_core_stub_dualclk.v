module scope_core_stub_dualclk #(
    ...
    //====================================================
    // 6. 双时钟双 buffer
    // sys_clk 写入，vga_clk 读取
    //====================================================
    waveform_double_buffer_dualclk #(
        .DATA_WIDTH (8),
        .ADDR_WIDTH (10),
        .FRAME_LEN  (640)
    ) u_waveform_double_buffer_dualclk (
        .sys_clk         (sys_clk),
        .rst_n           (rst_n),
